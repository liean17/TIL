...
4. 종류 별 차이  **CentOS 와 Ubuntu를 예로 들어 보충**
...
- 해야하는 이유
    - (**어떤**)문제가 발생했을때 빠르게 원인을 파악할 수 있는 수단이된다.
    ...
    - **모니터링 예시**  
    무슨 문제가 있어서 무슨 수치를 봤는데, 무슨 문제라고 생각 될 수 있지만 다른 수치도 확인해야한다(https://onecellboy.tistory.com/190)  
